-- Migration: 20260721_fix_push_notify_parcel_dual_channel
-- Description: Restaura o disparo dual (FCM Push + WhatsApp Meta API) na função public.push_notify_parcel()
