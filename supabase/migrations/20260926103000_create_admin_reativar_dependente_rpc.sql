-- ==============================================================================
-- Migration: 20260926103000_create_admin_reativar_dependente_rpc.sql
-- Module: Base Cadastral 360º — Gate 3G.2-A (Parte 3D.1)
-- Scope: RPC public.admin_reativar_dependente
-- ==============================================================================
...
COMMENT ON FUNCTION public.admin_reativar_dependente(UUID, TEXT) IS 'Reativa dependente inativo com verificação de responsável, unicidade ativa, registro de motivo e auditoria DEPENDENT_REACTIVATED (Gate 3G.2-A Parte 3D.1)';
