...
const FN_TO_NAV: Record<string, { label: string; href: string; icon: React.ReactNode }> = {
  ...
  parcel_history:     { label: 'Histórico Encomendas',     href: '/condo/historico-encomendas',  icon: <ClipboardList size={18} /> },
  ...
  pending_del:        { label: 'Encomendas do Condomínio',  href: '/condo/encomendas-admin',      icon: <Package size={18} /> },
...
const PORTER_NAV: NavItem[] = [
  ...
  { label: 'Encomendas do Condomínio', href: '/condo/encomendas-admin', icon: <Package size={18} /> },
  { label: 'Reservas', href: '/condo/reservas', icon: <CalendarDays size={18} /> },
