...
import MoradoresClient from '@/app/admin/moradores/moradores-client'
import { AlertCircle } from 'lucide-react'

export default async function CondoMoradoresPage() {
  ...
  const mappedMoradores = moradores?.map(m => ({
    ...m,
    whatsapp: m.celular
  })) ?? []
  ...
  return (
    <div className="p-6 lg:p-8">
      <MoradoresClient moradores={mappedMoradores} tipoEstrutura={tipoEstrutura} />
    </div>
  )
}
