    ...
    <div className="max-w-5xl">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Building2 size={22} className="text-[#E85D26]" />
          <div>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#E85D26] text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-[#d44e1e] transition-colors"
        >
          <Plus size={16} />
          Nova Área
        </button>
        ...
        <div ref={formRef} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mt-8 scroll-mt-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-4">
            <select
              ...
              className="col-span-2 border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30"
            >
            ...
            <select
              ...
              className="border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30 text-gray-700"
            >
            ...
            <input
              ...
              className="border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30"
            />
              ...
              <div key={i} className="border border-gray-100 rounded-xl p-3 space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 border border-gray-200 rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30"
                  />
                </div>
                <textarea
                  rows={2}
                  ...
                  className="w-full border border-gray-200 rounded-lg px-2 py-1.5 text-xs resize-none focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30"
                />
              </div>
            ))}
          </div>
          ...
          <textarea
            ...
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm resize-none mb-4 focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30"
          />
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handleSave}
              disabled={saving}
              className="bg-[#E85D26] text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-[#d44e1e] transition-colors disabled:opacity-50"
            >
