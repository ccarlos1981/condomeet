    ...
    <div className="max-w-3xl">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-1">
          <Megaphone size={22} className="text-[#E85D26]" />
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-8">
        ...
        <input
          ...
          className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm mb-1 focus:outline-none focus:ring-2 focus:ring-[#E85D26]/30 focus:border-[#E85D26]"
        />
        ...
        <button
          onClick={handleSend}
          disabled={sending}
          className="mt-4 flex items-center gap-2 bg-[#E85D26] hover:bg-[#d44e1e] text-white px-6 py-2.5 rounded-full text-sm font-semibold transition-colors disabled:opacity-50"
        >
          <Send size={14} />
